...
/**
 * Class ACF_PERSIAN_DATEPICKER_FIELD
 *
 ...
 */
class ACF_PERSIAN_DATEPICKER_FIELD extends acf_field
{
    /*
    *  __construct
    *
    ...
    */
    function __construct($settings)
    {
        ...
        */
        $this->name = 'persian-datepicker';

        /*
        *  label (string) Multiple words, can include spaces, visible when selecting a field type
        */
        $this->label = __('Persian DatePicker', 'acf-persian-datepicker');
    ...
    function render_field_settings($field)
    {
        ...
        */
        acf_render_field_setting($field, array(
            'label' => __('Format Time', 'acf-persian-datepicker'),
            'instructions' => __('Please Write Format Of Showing DateTime, Read More', 'acf-persian-datepicker') . ' http://behzadi.github.io/persianDatepicker/#format ',
            'type' => 'text',
            'name' => 'format-date',
            //'prepend'		=> 'px',
        ));
    ...
    */
    ...
    function render_field($field)
    {
        ...
        */
        // http://behzadi.github.io/persianDatepicker/
        ?>
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                jQuery("input[data-field=<?=$field['key']?>]").persianDatepicker({
                    ...
                    $select = explode("-", esc_attr($field['value']));
                    ?>
                    , selectedDate: "<?php echo $select[0] . '/' . ltrim($select[1]) . '/' . ltrim($select[2]) ?>"
                    <?php
                    }
                    ?>
                });
        ...
        <input type="text" data-field="<?= $field['key'] ?>" class="<?= $field['wrapper']['class'] ?>"
               id="<?= $field['wrapper']['id'] ?>" <?php
        if (!empty($value)) {
            ?>
    ...
    */
    ...
    function input_admin_enqueue_scripts()
    {
        ...
        wp_register_script('persian-datepicker', "{$url}assets/js/persianDatepicker.js", array('acf-input'), $version);
        wp_enqueue_script('persian-datepicker');

        // register & include CSS
        wp_register_style('persian-datepicker-default', "{$url}assets/css/persianDatepicker-default.css", array('acf-input'), $version);
        wp_enqueue_style('persian-datepicker-default');
    }
    ...
    */
    ...
    function validate_value( $valid, $value, $field, $input ){
        ...
        if( $value < $field['custom_minimum_setting'] )
        {
            $valid = __('The value is too little!','acf-persian-datepicker'),
        }
...
// initialize
new ACF_PERSIAN_DATEPICKER_FIELD($this->settings);
